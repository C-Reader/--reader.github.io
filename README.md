...
<html lang="ru">
  <head>
    ...
    <meta property="og:site_name" content="Информационная страница CodeReader">
    <meta property="og:image" content="images/ogimage.png">
    <meta name="generator" content="onepage">
    <meta name="theme-color" content="#59d1d3">
    <title>
      Актуальные контактные данные | Информационная страница CodeReader
    </title>
    <link rel="apple-touch-icon" sizes="180x180" href="images/apple-touch-icon-180x180.png?v=1700569218">
    <link rel="icon" type="image/png" sizes="256x256" href="images/android-chrome-256x256.png?v=1700569218">
    <link rel="icon" type="image/png" sizes="192x192" href="images/android-chrome-192x192.png?v=1700569218">
    <link rel="icon" type="image/png" sizes="150x150" href="images/mstile-150x150.png?v=1700569218">
    <link rel="icon" type="image/png" sizes="32x32" href="images/favicon-32x32.png?v=1700569218">
    <link rel="icon" type="image/png" sizes="16x16" href="images/favicon-16x16.png?v=1700569218">
    <link rel="manifest" href="manifest.json">
    <link rel="mask-icon" href="images/safari-pinned-tab.svg" color="#59d1d3">
      ...
      <div class="header__container">
        <div class="header__logo">
          <div class="header__logo-text">
            Информационная страница CodeReader
          </div>
        </div>
      </div>
    </header>
        ...
        <section class="main__content">
          <div class="main__heading">
            <h1 class="main__title">
              Актуальные &nbsp;контактные данные<br>
            </h1>
